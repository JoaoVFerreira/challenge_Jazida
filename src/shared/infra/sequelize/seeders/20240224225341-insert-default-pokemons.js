...
const pokemons = [
  ...
  { tipo: "Bulbasaur", treinador: "Ash", nivel: 1, created_at: new Date(), updated_at: new Date() },
  { tipo: "Charmander", treinador: "Misty", nivel: 1, created_at: new Date(), updated_at: new Date() },
  { tipo: "Squirtle", treinador: "Brock", nivel: 1, created_at: new Date(), updated_at: new Date() },
  ...
  { tipo: "Mewtwo", treinador: "Red", nivel: 10, created_at: new Date(), updated_at: new Date() },
